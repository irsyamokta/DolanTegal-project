...
const lang = {
    idn: {
        ...
        facilitys: {
            card: ['Warung Wisata', 'Spot Foto', 'Musholla', 'Toilet', 'Perahu Wisata', 'Area Parkir', 'Area Camping', 'Area Pancing', 'Walking Track', 'Panggung'],
        },
    ...
    eng: {
        ...
        facilitys: {
            card: ['Restaurant', 'Photography', 'Shrine', 'Toilet', 'Boat', 'Parking Area', 'Camping Area', 'Fishing Area', 'Walking Track', 'Stage']
        },
