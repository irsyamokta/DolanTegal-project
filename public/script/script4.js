...
const lang = {
    idn: {
        ...
        emptyFavorite:{
            title: 'Ooppss.. Masih kosong',
            subtitle: 'Jelajahi wisata destinasi yang ada di Tegal dan jadikan favorit Anda ketika sedang pergi menikmati liburan',
            link: 'Jelajahi Sekarang',
        }
    },
    eng: {
        ...
        emptyFavorite: {
            title: 'Ooppss.. It\'s empty',
            subtitle: 'Explore the destinations that are available in Tegal and make them your favorite when you\'re on a trip',
            link: 'Explore Now',
        }
    }
}
...
function setLanguage(language) {
    ...
    document.getElementById('fav-empty').innerText = selectedLang.emptyFavorite.title;
    document.getElementById('fav-info').innerText = selectedLang.emptyFavorite.subtitle;
    document.getElementById('btn-empty').innerText = selectedLang.emptyFavorite.link;
