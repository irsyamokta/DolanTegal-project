...
const lang = {
    idn: {
        ...
        facilitys: {
            card: ['Warung Wisata', 'Spot Foto', 'Toilet', 'Area Parkir', 'Area Camping', 'Area Bersantai', 'Gazebo']
        },
    ...
    eng: {
        ...
        facilitys: {
            card: ['Restaurant', 'Photography', 'Toilet', 'Parking Area', 'Camping Area', 'Rest Area', 'Gazebo']
        },
