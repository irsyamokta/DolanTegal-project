...
const lang = {
    idn: {
        ...
        facilitys: {
            card: ['Warung Wisata', 'Spot Foto', 'Musholla', 'Toilet', 'Perahu Wisata', 'Area Parkir', 'Area Camping', 'Playground', 'Walking Track', 'Gazebo'],
        },
    ...
    eng: {
        ...
        facilitys: {
            card: ['Restaurant', 'Photography', 'Shrine', 'Toilet', 'Boat', 'Parking Area', 'Camping Area', 'Playground', 'Walking Track', 'Gazebo']
        },
